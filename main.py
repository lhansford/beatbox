...
class MainGui(QtGui.QMainWindow):
    ...
    def initUI(self):
        ...
        self.show()
        self.raise_() # Brings app to front
...
class PlayerGui(QtGui.QWidget):
    ...
    def initUI(self):
        ...
        self.load_button = ImageButton(self)
        ...
        self.back_button = ImageButton(self)
        ...
        self.forward_button = ImageButton(self)
        ...
        self.volume_button = ImageButton(self)
    ...
    def choose_song(self):
        self.current_song = QtGui.QFileDialog.getOpenFileName(self, "Choose a song")[0]
        self.load_song()
        
    def load_song(self):
        if self.current_song != "": ##If the user cancels the file dialog it returns as an empty string.
